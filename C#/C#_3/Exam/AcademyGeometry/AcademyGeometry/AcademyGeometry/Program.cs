...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IFlat, IVolumeMeasurable
    {
        public double Radius { get; private set; }
        ...
        public double GetArea()
        {
            ...
            double topAndBottom = 2 * baseArea;
    ...
    public class AdvancedEngineController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            ...
            {
                case "area":
                    var currentAsIAreaMeasurable = this.currentFigure is IAreaMeasurable;
